...
DETRAN DF: Veículo (Mobile) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_df_veiculo_mobile@mcp.ai](mailto:detran_df_veiculo_mobile@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
